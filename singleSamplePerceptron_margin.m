function [a] =singleSamplePerceptron(data, label, margin) 
%Implementation of the Single Sample Perceptron Algorithm with margin for binary classification
%Initializing
n=size(data,1);
one=ones(n,1);
a = ones(1,3); 
